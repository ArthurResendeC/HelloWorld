...
// post = {id: number, title: string, content: string, createdAt: Date, updateAt: Date}
...
const postModel = {
    ...
    createPost(title, content) {
        const newPost = { id: Date.now().toString(), title: title, content: content, createdAt: Date.now(), updatedAt: Date.now() }
        return newPost
    },
