...
function App() {
  return (
    <div className="p-6 flex flex-col items-center">
      ...
      <div className="flex flex-wrap gap-12 justify-center mt-2">
        {games.map((game)=>{
          return(
            <div>
              <img 
                ...
                className="w-80 h-96" 
              />
              <h2 className="text-2xl font-semibold">{game.title} ({game.releaseYear})</h2>
              <p className="text-xl w-72">{game.description}</p>
            </div>
          )
        })}
      </div>
