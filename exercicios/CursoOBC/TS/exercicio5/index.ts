...
function saveSpaceship(name:string, pilot:string, crewLimit:number, crew:string[], inMission:boolean = false): Spaceship {
...
function addMember(spaceship:Spaceship, crewMember:string):void { 
...
function sendToMission(spaceship:Spaceship):void {
