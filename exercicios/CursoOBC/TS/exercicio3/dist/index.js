function sendSpaceship(name, captain) {
    ...
    alert("A nave ".concat(spaceship.name, " comandado pelo capt\u00E3o ").concat(spaceship.captain, " foi enviada em uma miss\u00E3o!"));
    return spaceship;
}
function accelerate(targetSpeed, spaceship) {
    if (spaceship.speed > targetSpeed) {
        alert("Reduzindo a velocidadde da ".concat(spaceship.name, " para ").concat(targetSpeed, "..."));
    }
